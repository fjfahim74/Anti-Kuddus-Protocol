    ...
    function subscribeToAlerts() {
        ...
        unsubscribeActive = listenActiveAlerts({
            ...
            onError: function (err) {
                UI.toast('SOS alerts aren\'t loading — see console for details (' + (err.code || err.message) + ')', 'danger', 8000);
            }
        });
        ...
        unsubscribeResolved = listenResolvedAlerts(function (alerts) {
            ...
            UI.toast('Resolved alerts aren\'t loading — see console for details (' + (err.code || err.message) + ')', 'danger', 8000);
        });
    }
